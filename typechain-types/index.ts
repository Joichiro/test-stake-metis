...
export type { TestMetisToken } from "./contracts/ERC20.sol/TestMetisToken";
export { TestMetisToken__factory } from "./factories/contracts/ERC20.sol/TestMetisToken__factory";
